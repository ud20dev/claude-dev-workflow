...
4. For docs/PROGRESS.md (PART B): don't try to auto-split its past
   ...
   docs/CHANGELOG.md), then create fresh docs/frontend/PROGRESS.md and
   docs/backend/PROGRESS.md from the template (empty, ready for new
   sessions). Only after that, docs/PROGRESS.md is regenerated by
   .claude/scripts/merge-progress.sh and becomes a generated file.
